...
def parse_args():
    parser = argparse.ArgumentParser(description="SAC training for dynamic 2-obstacle navigation")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--timesteps", type=int, default=1_500_000)
    parser.add_argument("--arena_size", type=float, default=10.0)
    parser.add_argument("--log_dir", type=str, default="./logs_dynamic2_sac")
    parser.add_argument("--tb_dir", type=str, default="./tb_logs_dynamic2_sac")
    parser.add_argument("--ckpt_dir", type=str, default="./checkpoints_dynamic2_sac")
    ...
    parser.add_argument("--model_out", type=str, default="sac_dynamic2_navigation_seed{seed}")
    parser.add_argument("--vecnorm_out", type=str, default="vecnormalize_dynamic2_sac_seed{seed}.pkl")
...
def build_train_env(arena_size: float, log_dir: str):
    def _make():
        return Monitor(
            DynamicObstacleNavEnv(arena_size=arena_size),
...
def main():
    ...
    if args.resume_model_path:
        model = SAC.load(args.resume_model_path, env=train_env, device="auto")
