...
def parse_args():
    parser = argparse.ArgumentParser(description="SAC training for static 2-obstacle navigation")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--timesteps", type=int, default=1_500_000)
    parser.add_argument("--arena_size", type=float, default=10.0)
    parser.add_argument("--log_dir", type=str, default="./logs_static2_sac")
    parser.add_argument("--tb_dir", type=str, default="./tb_logs_static2_sac")
    parser.add_argument("--ckpt_dir", type=str, default="./checkpoints_static2_sac")
    ...
    parser.add_argument("--model_out", type=str, default="sac_static2_navigation_seed{seed}")
    parser.add_argument("--vecnorm_out", type=str, default="vecnormalize_static2_sac_seed{seed}.pkl")
